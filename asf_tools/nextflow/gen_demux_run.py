...
class GenDemuxRun:
    ...
    def run(self):
        ...
        for run_name in dir_diff:
            try:
                self.process_cli_run(self.api, run_name, self.mode)
    ...
    def process_cli_run(self, api: ClarityHelperLims, run_name: str, mode: DataTypeMode):
        """
        Per run processing
        """
        ...
        if self.use_api is True:
            ...
            sample_dict = self.get_samplesheet(api, run_name, mode)
